...
static const struct linear_range tps6287x_voltage_ranges[] = {
	REGULATOR_LINEAR_RANGE(400000, 0, 0xFF, 1250),
	REGULATOR_LINEAR_RANGE(400000, 0, 0xFF, 2500),
	REGULATOR_LINEAR_RANGE(400000, 0, 0xFF, 5000),
	REGULATOR_LINEAR_RANGE(800000, 0, 0xFF, 10000),
};
